...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <div class="row">
            <div class="col-8 p-0 align-items-center justify-content-center mx-auto">
                <div class="card">
                    <div class="card-header justify-content-between py-3">
                        <h4 class="card-title float-left pt-2">All Products</h4>

                        <div class="float-right d-flex my-auto gap-3">

                            <div class="col-md-6">
                                <ol class="float-right button">
                                    <div href="" class="btn btn-success" rel="tooltip" id="addnew" title="add">
                                        Add New
                                    </div>
                                </ol>
                            </div>

                            <form class="mb-0 pb-0" id="sort_products" action="" method="POST" action="{{route('products.store')}}">
                                @csrf
                                @method('POST')
